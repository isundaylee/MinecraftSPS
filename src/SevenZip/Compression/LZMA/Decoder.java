...
public class Decoder
{
  ...
  class LiteralDecoder
  {
    ...
    class Decoder2
    {
      ...
      public void Init() { SevenZip.Compression.RangeCoder.Decoder.InitBitModels(this.m_Decoders); }
  ...
  class LenDecoder
  {
    ...
    public void Create(int numPosStates) { for (; this.m_NumPosStates < numPosStates; this.m_NumPosStates += 1)
      {
 ...
 * Qualified Name:     SevenZip.Compression.LZMA.Decoder
